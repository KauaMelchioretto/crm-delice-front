...
class KanbanRepository {
  ...
  async getBoardByKey(key: string): Promise<BoardResponse> {
    try {
      const response = await http.get(`/kanban/board/code/${key}`);
  ...
  async getBoardByUUID(boardUUID: string): Promise<BoardResponse> {
    try {
      const response = await http.get(`/kanban/board/${boardUUID}`);
  ...
  async getTagsByBoardUUID(boardUUID: string): Promise<TagListResponse> {
    try {
      const response = await http.get(`/kanban/tagByBoardUUID/${boardUUID}`);
  ...
  async getColumnsByBoardUUID(boardUUID: string): Promise<ColumnListResponse> {
    try {
      const response = await http.get(`/kanban/columnByBoardUUID/${boardUUID}`);
  ...
  async deleteColumnByUUID(columnUUID: string): Promise<MessageBoardResponse> {
    try {
      const response = await http.delete(
        `/kanban/deleteColumnByUUID/${columnUUID}`
      );
  ...
  async reorderColumns(columns: ReorderColumn[]): Promise<ColumnListResponse> {
    try {
      const response = await http.post("/kanban/reorderColumns", columns);
  ...
  async saveColumnRule(rule: ColumnRule): Promise<ColumnRuleResponse> {
    try {
      const response = await http.post("/kanban/saveColumnRule", rule);
  ...
  async getColumnRuleByUUID(uuid: string): Promise<ColumnRuleResponse> {
    try {
      const response = await http.get(`/kanban/getColumnRuleByUUID/${uuid}`);
  ...
  async deleteAllowedColumnUUID(
    column: string,
    allowed: string
  ): Promise<MessageBoardResponse> {
    try {
      const response = await http.delete(
        `/kanban/deleteAllowedColumnUUID/${column}/${allowed}`
      );
  ...
  async deleteColumnRuleByUUID(
    columnRule: string
  ): Promise<MessageBoardResponse> {
    try {
      const response = await http.delete(
        `/kanban/deleteColumnRuleByUUID/${columnRule}`
      );
  ...
  async getColumnByUUID(uuid: string): Promise<ColumnResponse> {
    try {
      const response = await http.get(`/kanban/column/${uuid}`);
  ...
  async getCardByUUID(cardUUID: string): Promise<CardResponse> {
    try {
      const response = await http.get(`/kanban/card/${cardUUID}`);
  ...
  async getColumnRuleTypes(): Promise<ColumnRuleTypeListResponse> {
    try {
      const response = await http.get("/kanban/getColumnRuleTypes");
